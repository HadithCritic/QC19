...
export const engine = {
  ...
  textModes: () => call<TextModes>("textModes.list"),
  saveTextMode: (mode: TextMode) => call<TextMode>("textModes.save", mode),
  deleteTextMode: (name: string) => call<boolean>("textModes.delete", { name }),
