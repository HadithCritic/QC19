...
internal sealed class Dispatcher
{
    ...
    public Dispatcher(Handlers handlers, UserHandlers? user, TextWriter log)
    {
        ...
        _methods = new Dictionary<string, Method>(StringComparer.Ordinal)
        {
            ...
            ["initials.list"] = NoParams(handlers.Initials, json.IReadOnlyListInitialedChapterDto),
            ...
            ["selection.letters"] = With(json.SelectionParams, handlers.SelectionLetters, json.IReadOnlyListLetterStatisticDto),
            ["selection.maths"] = With(json.SelectionParams, handlers.SelectionMaths, json.MathsDto),
            ["selection.symmetry"] = With(json.SelectionParams, handlers.SelectionSymmetry, json.SymmetryDto),
            ["selection.allah"] = With(json.SelectionParams, handlers.SelectionAllah, json.AllahSummaryDto),
            ["research.words"] = With(json.ResearchParams, handlers.ResearchWordList, json.ResearchTableDto),
            ["ratio.split"] = With(json.RatioParams, handlers.RatioSplit, json.IReadOnlyListRatioUnitDto),
