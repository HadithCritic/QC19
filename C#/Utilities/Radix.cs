...
public class Radix
{
    // CAPITAL LETTERS for digit symbols. Small letters are for Math functions and constants
            ...
            if (symbolic_display)
            {
                ...
                if (pos > -1)
                {
                    ...
                    for (int i = 0; i < t.Length; i++)
                    {
                        ...
                        if ((l < 0) || (l >= radix)) throw new Exception(ErrRadixFormat);
                        result += l;
                    }
                    // add sign
                    result *= si;
    ...
    public static string Encode(double value, int radix, bool symbolic_display)
    {
        ...
        if (symbolic_display)
        {
            ...
            while (t2 > 0.0D)
            {
                long r = (long)Math.Round((t2 * radix));
                result += r.ToString() + ",";
                t2 = (t2 * radix) - r;
            ...
            if (symbolic_display)
            {
                ...
                if (pos > -1)
                {
                    ...
                    for (int i = 0; i < t.Length; i++)
                    {
                        ...
                        // next 'digit'
                        long l = long.Parse(t[i]);
                        if ((l < 0L) || (l >= radix)) throw new Exception(ErrRadixFormat);
    ...
    public static void Test(string[] args)
    {
        ...
        Console.WriteLine(s);
        Console.WriteLine();
        s = Radix.Encode(1000000000000L, 11);
        Console.WriteLine(s);
