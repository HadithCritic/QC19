...
interface IMetaCollection<T> : IEnumerable<IList<T>>
{
    ...
    /// <summary>
    /// The upper index of the meta-collection, which is the m_size of the input collection.
    /// </summary>
    int UpperIndex { get; }

    /// <summary>
    /// The lower index of the meta-collection, which is the m_size of each output collection.
    /// </summary>
    int LowerIndex { get; }
}
