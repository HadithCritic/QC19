...
// Distributed under license terms of CPOL https://codeproject.com/info/cpol10.aspx
using System;
...
public class Permutations<T> : IMetaCollection<T>
{
    ...
    public class Enumerator : IEnumerator<IList<T>>
    {
        ...
        /// Performance is further increased by using value types and removing generics, that is, the LexicographicOrder parellel m_candidates.
        ...
        /// https://cut-the-knot.org/do_you_know/AllPerm.shtml
        ...
        /// This swaps both the lexicographical order and the values, maintaining the parallel m_candidates.
        /// </summary>
        ...
        /// <summary>
        /// Parrellel m_candidates of integers that represent the location of items in the myValues m_candidates.
    ...
    /// </summary>
    /// <remarks>
    /// Copies information provided and then creates a parellel int m_candidates of lexicographic
    /// orders that will be used for the actual permutation algorithm.  
    /// The input m_candidates is first sorted as required for WithoutRepetition and always just for consistency.
    /// This m_candidates is constructed one of two way depending on the type of the collection.
    ///
    ...
    /// E.g.
    /// Input m_candidates:          {A A B C D E E}
    /// Lexicograhpic Orders: {1 2 3 4 5 6 7}
    /// 
    /// When type is MetaCollectionType.WithoutRepetition, then fewer are generated, with each
    /// identical element in the input m_candidates not repeated.  The lexicographic sort algorithm
