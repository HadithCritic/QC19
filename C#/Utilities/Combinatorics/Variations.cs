...
/// ordered subsets of a particular m_size from the set of values.  
...
public class Variations<T> : IMetaCollection<T>
{
    ...
    /// <param name="lowerIndex">The m_size of each variation set to return.</param>
    ...
    /// </summary>
    /// <param name="values">List of values to select variations from.</param>
    /// <param name="lowerIndex">The m_size of each vatiation set to return.</param>
