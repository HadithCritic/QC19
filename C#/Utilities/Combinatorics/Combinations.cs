...
/// subsets of a particular m_size from the set of values.  This list is enumerable and 
...
public class Combinations<T> : IMetaCollection<T>
{
    ...
    /// <summary>
    /// No default constructor, must provided a list of values and m_size.
    /// </summary>
    ...
    /// <param name="lowerIndex">The m_size of each combination set to return.</param>
    ...
    public class Enumerator : IEnumerator<IList<T>>
    {
        ...
        /// by creating a new list of those items that have a true in the permutation parrellel m_candidates.
        /// </remarks>
        ...
        /// 
        /// For type WithoutRepetition, the output is a straightforward subset of the input m_candidates.  
        /// E.g. 6 choose 3 without repetition
        /// Input m_candidates:   {A B C D E F}
        /// Permutations:  {0 1 0 0 1 1}
        /// Generates set: {A   C D    }
        /// Note: m_size of permutation is equal to upper index.
        /// 
        ...
        /// Note: m_size of permutation is equal to upper index - 1 + lower index.
        /// </remarks>
    ...
    /// This value is mathematically defined as Choose(M, N) where M is the set m_size
    /// and N is the subset m_size.  This is M! / (N! * (M-N)!).
    /// </summary>
    public long Count
    {
        get
    ...
    /// <param name="type">The type of Combinations set to generate.</param>
    /// <remarks>
    /// Copies the m_candidates and parameters and then creates a map of booleans that will 
