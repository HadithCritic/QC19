...
namespace Maths
{
    ...
    public class NumberExpression : ExpressionBase
    {
        ...
        /// <param name="character">The char to test.</param>
        ...
        public static bool IsNumber(char character)
        {
            ...
            return char.IsDigit(character) || f.NumberDecimalSeparator.IndexOf(character) >= 0;
        }

        /// <summary>Determines whether the specified char is negative sign.</summary>
        /// <param name="character">The char to check.</param>
        /// <returns><c>true</c> if the specified char is negative sign; otherwise, <c>false</c>.</returns>
        public static bool IsNegativeSign(char character)
        {
            NumberFormatInfo f = CultureInfo.CurrentUICulture.NumberFormat;
            return f.NegativeSign.IndexOf(character) >= 0;
        }
