                ...
                if (control != null)
                {
                    ...
                    switch (j)
                    {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            control.BackColor = Numbers.NUMBER_KIND_BACKCOLORS[2];
                            break;
                        case 9:
                        case 10:
                ...
                if (int.TryParse(index_control.Text, out number))
                {
                    ...
                    if (number > 0)
                    {
                        ...
                        try
                        {
                            ...
                            controls[point.X, 4].ForeColor = Numbers.GetNumberForeColor(c);
                            controls[point.X, 5].ForeColor = Numbers.GetNumberForeColor(ac);
                            controls[point.X, 6].ForeColor = Numbers.GetNumberForeColor(xc);

                            long df = Numbers.DeficientNumbers[i];
                            long ab = Numbers.AbundantNumbers[i];
                            controls[point.X, 7].Text = df.ToString();
                            controls[point.X, 8].Text = ab.ToString();
                            controls[point.X, 7].ForeColor = Numbers.GetNumberForeColor(df);
                            controls[point.X, 8].ForeColor = Numbers.GetNumberForeColor(ab);
                            ...
                            controls[point.X, 9].ForeColor = Numbers.GetNumberForeColor(p4nplus1);
                            controls[point.X, 10].ForeColor = Numbers.GetNumberForeColor(p4nminus1);
                            controls[point.X, 11].ForeColor = Numbers.GetNumberForeColor(c4nplus1);
                            controls[point.X, 12].ForeColor = Numbers.GetNumberForeColor(c4nminus1);
                            ...
                            controls[point.X, 13].ForeColor = Numbers.GetNumberForeColor(sum);
                            controls[point.X, 14].ForeColor = Numbers.GetNumberForeColor(sum_of_digit_sums);
                            controls[point.X, 15].ForeColor = Numbers.GetNumberForeColor(sum_of_digital_roots);
                            ...
                            controls[point.X, 16].ForeColor = Numbers.GetNumberForeColor(half);
                            controls[point.X, 17].ForeColor = Numbers.GetNumberForeColor(median);
                            controls[point.X, 18].ForeColor = Numbers.GetNumberForeColor(product);
                        }
                        catch
                        {
                            ClearCells(point.X);
                        ...
                        if (long.TryParse((sender as TextBox).Text, out number))
                        {
                            ...
                            switch (point.Y)
                            {
                                ...
                                case 6:
                                    ...
                                    break;
                                case 7:
                                    index = Numbers.DeficientNumberIndexOf(number) + 1;
                                    break;
                                case 8:
                                    index = Numbers.AbundantNumberIndexOf(number) + 1;
                                    break;
                                default:
                                    index = 0;
                                    break;
